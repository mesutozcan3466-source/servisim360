...
class _WebAdminPanelState extends State<WebAdminPanel> {
  ...
  static const List<_MenuItem> _menuler = [
    ...
    _MenuItem('Soforler',    Icons.directions_car_outlined, 2),
    _MenuItem('Ogrenciler',  Icons.school_outlined,         3),
    _MenuItem('Veliler',     Icons.family_restroom_outlined,4),
    _MenuItem('Devamsizlik', Icons.event_busy_outlined,     5),
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    Text(item.ad, style: TextStyle(
                        ...
                        fontWeight: secili ? FontWeight.bold : FontWeight.normal,
                        fontSize: 13)),
                    if (item.index == 5 && _bekleyenDevamsizlik > 0) ...[
                      const Spacer(),
                      Container(
  ...
  Widget _sekmeIcerigi() {
    switch (_aktifSekme) {
      ...
      case 2: return WebSoforler(firmaId: _firmaId);
      case 3: return _OgrencilerSekme(firmaId: _firmaId, projeId: _projeId);
      case 4: return _VelilerSekme(firmaId: _firmaId);
      case 5: return _DevamsizlikSekme(firmaId: _firmaId);
      case 6: return const WebRaporlar();
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Wrap(spacing: 14, runSpacing: 14, children: [
          _WebStatKart('Toplam Sofor', '$toplamSurucu', Icons.directions_car_outlined, _navy,
              alt: aktifServis > 0 ? '$aktifServis aktif' : null,
              onTap: () => onNavigate(2)),
          _WebStatKart('Toplam Ogrenci', '$toplamOgrenci', Icons.school_outlined, Colors.blue,
              onTap: () => onNavigate(3)),
          _WebStatKart('Toplam Veli', '$toplamVeli', Icons.family_restroom_outlined, Colors.purple,
              onTap: () => onNavigate(4)),
          _WebStatKart('Bekleyen Devamsizlik', '$bekleyenDevamsizlik',
              Icons.event_busy_outlined,
              bekleyenDevamsizlik > 0 ? Colors.red : Colors.teal,
              onTap: () => onNavigate(5)),
        ]),
